  ...
  return (
    <div className="bg-ink flex flex-col min-h-screen">
      ...
      <section className="bg-ink px-6 py-24 flex-1 flex items-center justify-center text-center">
        <div className="mh-card mh-fade-in bg-surface border-l-4 border-line rounded-xl px-10 py-10">
          <h1 className="font-display text-2xl text-paper">Data Sources</h1>
